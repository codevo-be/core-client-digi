...
export default function HouseSizeSection({ handleValue, onBack, onValid }: Props) {
    ...
    //TODO Faire un clacul ici pourle mètre carré ? -> 1 valeur dans l'excel ?
        ...
        <div className={"flex flex-col items-center gap-[5.7rem]"}>
            ...
            <div className={"flex gap-[2.9rem]"}>
                <Form.Group className={"bg-white p-[2.9rem] h-[44.2rem] w-[46.3rem] rounded-2xl"}>
                    ...
                    <Form.Field name={"houseSquare"} suffix={"m2"} placeholder={"..."}/>
                </Form.Group>
                ...
                <Form.Group className={"bg-white p-[2.9rem] h-[44.2rem] w-[46.3rem] rounded-2xl"}>
                    ...
                    <Form.Field name={"houseDimensionLength"} suffix={"m"} placeholder={"..."}/>
                    <Form.Field name={"houseDimensionWidth"} suffix={"m"} placeholder={"..."}/>
                </Form.Group>
            </div>

            <StepNavigation showSkip={true} onSkip={() => {
                handleValue('houseSquare', 'something');
                handleValue('houseDimension', 'something');
                onValid();
